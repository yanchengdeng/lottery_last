...
/**
 * Author: 邓言诚  Create at : 2018/9/26  22:19
 * Email: yanchengdeng@gmail.com
 * Describle: 分红积分转出
 */
public class SharebounsRollOutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sharebouns_roll_out);
