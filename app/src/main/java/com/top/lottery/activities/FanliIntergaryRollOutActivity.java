...
/**
 * Author: 邓言诚  Create at : 2018/9/26  13:46
 * Email: yanchengdeng@gmail.com
 * Describle: 返利积分转出
 */
public class FanliIntergaryRollOutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fanli_intergary_roll_out);
        ButterKnife.bind(this);

        setTitle("返利积分转出");

        tvUseableTotal.setText(String.valueOf(Utils.getUserInfo().score));
        tvFanlijifen.setText(String.valueOf(Utils.getUserInfo().daili_score));
