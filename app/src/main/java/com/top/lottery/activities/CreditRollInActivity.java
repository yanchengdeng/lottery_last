...
/**
 * Author: 邓言诚  Create at : 2018/9/26  22:31
 * Email: yanchengdeng@gmail.com
 * Describle: 信用积分转入
 */
public class CreditRollInActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_credit_author)
    TextView tvCreditAuthor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_roll_in);
        ButterKnife.bind(this);
        setTitle("信用积分转入");

        tvUseableTotal.setText(String.valueOf(Utils.getUserInfo().score));
        tvCreditLeft.setText(String.valueOf(Utils.getUserInfo().credit_balance_score));
        tvCreditAuthor.setText(String.valueOf(Utils.getUserInfo().credit_line_score));
